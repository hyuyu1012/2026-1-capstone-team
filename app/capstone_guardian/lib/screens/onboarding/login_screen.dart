...
/// First screen — social / email sign-in. Per the project decision the buttons
/// are UI-only: social taps advance straight to the branch screen, email opens
/// the secondary email form.
class LoginScreen extends StatelessWidget {
  const LoginScreen({super.key});

  void _next(BuildContext context) {
    Navigator.of(context).push(MaterialPageRoute(builder: (_) => const BranchScreen()));
  }
